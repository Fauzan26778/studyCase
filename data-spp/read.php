                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="../data-spp/create.php" class="btn btn-success">Tambah Data SPP</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 20%">
                                           <a href="update-spp.php?id_spp=<?php echo $data['id_spp']; ?>" 
                                           class="btn btn-warning my-1">Update</a>
                                           <a href="action-delete-spp.php?id_spp=<?php echo $data['id_spp']; ?>"
